...
namespace osu {
    ...
    public:
        ...
        void initialise(int width, int height) {
            ...
            GLuint positionLocation = Shader::postProcessor->getAttribLocation("position");
            GLuint texCordLocation = Shader::postProcessor->getAttribLocation("texCord");
            ...
            Shader::postProcessor->bind();
            Shader::postProcessor->uniform("screenTexture", 0);
        }
